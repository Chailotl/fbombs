...
public class AcmeBedBlockEntityRenderer implements BlockEntityRenderer<AcmeBedBlockEntity> {
    private final ModelPart bedHead;
    private final ModelPart bedFoot;

    public AcmeBedBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
    ...
    public void render(AcmeBedBlockEntity bedBlockEntity, float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
        ...
        if (world != null) {
            ...
            DoubleBlockProperties.PropertySource<? extends AcmeBedBlockEntity> propertySource = DoubleBlockProperties.toPropertySource(
                FBombsBlockEntities.ACME_BED,
                AcmeBedBlock::getBedPart,
                AcmeBedBlock::getOppositePartDirection,
                ChestBlock.FACING,
                blockState,
                world,
