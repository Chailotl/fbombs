...
public class LowPowerTntEntity extends AbstractTntEntity {
    ...
    public LowPowerTntEntity(World world, double x, double y, double z, @Nullable LivingEntity igniter, BlockState state) {
        super(FBombsEntityTypes.LOW_POWER_TNT, world, x, y, z, igniter, state);
    }
