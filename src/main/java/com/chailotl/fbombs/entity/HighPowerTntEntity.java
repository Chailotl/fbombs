...
public class HighPowerTntEntity extends AbstractTntEntity {
    ...
    public HighPowerTntEntity(World world, double x, double y, double z, @Nullable LivingEntity igniter, BlockState state) {
        super(FBombsEntityTypes.HIGH_POWER_TNT, world, x, y, z, igniter, state);
    }
