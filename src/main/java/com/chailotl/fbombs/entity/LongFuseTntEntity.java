...
public class LongFuseTntEntity extends AbstractTntEntity {
    ...
    public LongFuseTntEntity(World world, double x, double y, double z, @Nullable LivingEntity igniter, BlockState state) {
        super(FBombsEntityTypes.LONG_FUSE_TNT, world, x, y, z, igniter, state);
    }
